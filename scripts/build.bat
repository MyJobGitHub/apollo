...
set apollo_config_db_password="yuantu123"

rem apollo portal db info
set apollo_portal_db_url="jdbc:mysql://localhost:3306/apolloportaldb?characterEncoding=utf8"
set apollo_portal_db_username="root"
set apollo_portal_db_password="yuantu123"

rem meta server url, different environments should have different meta server addresses
set dev_meta="http://localhost:8080"
set fat_meta="http://someIp:8081"
set uat_meta="http://anotherIp:8082"
set pro_meta="http://yetAnotherIp:8083"
